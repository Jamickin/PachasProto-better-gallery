...
<!-- Updated Sidebar with responsive width -->
<aside
	class="sidebar fixed top-0 left-0 z-50 flex h-screen w-full transform flex-col bg-slate-50 shadow-2xl transition-transform duration-300 ease-in-out md:w-80"
	...
	<nav class="flex-1 overflow-y-auto bg-slate-50 p-6">
		<div class="space-y-2">
			<a
				on:click={closeSidebar}
				href="/"
				class="group flex items-center justify-center rounded-lg px-4 py-3 text-gray-700 transition-all duration-200 hover:bg-white hover:text-rose-600 hover:shadow-md"
			>
				<div class="flex items-center">
					<svg
						class="h-5 w-5 text-gray-400 transition-colors group-hover:text-rose-500"
						fill="none"
						stroke="currentColor"
						viewBox="0 0 24 24"
					>
			...
			>
				<div class="flex items-center">
					...
					<span class="ml-3 font-medium">À La Carte Menu</span>
				</div>
			</a>
			...
			>
				<div class="flex items-center">
					...
					<span class="ml-3 font-medium">Light Lunch Menu</span>
				</div>
			</a>
			...
			>
				<div class="flex items-center">
					...
					<span class="ml-3 font-medium">Wine List</span>
				</div>
			</a>
			...
			>
				<div class="flex items-center">
					...
					<span class="ml-3 font-medium">Private Dining & Events</span>
				</div>
			</a>
			...
			>
				<div class="flex items-center">
					...
					<span class="ml-3 font-medium">Contact & Reservations</span>
				</div>
			</a>
		</div>
	</nav>
